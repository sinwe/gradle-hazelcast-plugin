...
-------------- | -------------- | ----------------- | ----------- | ----------------------- | --------- | -----
0.18+          | 8.14.2, 9.0 - 9.7+ | 5.7.0        | 17          | 17, 21, 25              | 17+       | **Gradle 9 requires Java 17+**; Gradle 8.x only tested on JDK 17/21 (Gradle 8.x bundles ASM 9.7.1 which does not support JDK 25)
